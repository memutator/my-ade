...
const en = {
  ...
  scMisc: 'Misc',
  scNewPane: 'New terminal/browser/editor/todo pane',
  scSplit: 'Split focused pane',
  scClosePane: 'Close pane',
  scMinimize: 'Minimize pane',
  scFloat: 'Float/dock pane',
  scCycleFocus: 'Cycle pane focus',
  scDirFocus: 'Focus pane in direction',
  scNextWs: 'Next/previous workspace',
...
const ko: Record<TKey, string> = {
  ...
  scWindow: '창 · 패널',
  scMisc: '기타',
  scNewPane: '새 터미널/브라우저/에디터/할 일 패널',
  scSplit: '포커스된 패널 분할',
  scClosePane: '패널 닫기',
  scMinimize: '패널 최소화',
  scFloat: '패널 플로팅/도킹',
  scCycleFocus: '패널 포커스 순환',
  scDirFocus: '해당 방향의 패널로 포커스',
  scNextWs: '다음/이전 워크스페이스',
  scWsN: '워크스페이스 N 활성화',
